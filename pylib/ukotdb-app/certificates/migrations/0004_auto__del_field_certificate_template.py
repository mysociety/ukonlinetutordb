...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('certificates_certificate', 'template')
    
    
    def backwards(self, orm):
        
        # Adding field 'Certificate.template'
        db.add_column('certificates_certificate', 'template', self.gf('django.db.models.fields.CharField')(default='default', max_length=20), keep_default=False)
