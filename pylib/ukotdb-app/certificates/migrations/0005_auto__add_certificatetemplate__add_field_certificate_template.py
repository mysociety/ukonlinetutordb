...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('certificates_certificatetemplate', (
            ...
            ('slug', self.gf('django.db.models.fields.SlugField')(max_length=20, unique=True, db_index=True)),
            ('filename', self.gf('django.db.models.fields.CharField')(max_length=20, unique=True)),
        ...
        # Adding field 'Certificate.template'
        db.add_column('certificates_certificate', 'template', self.gf('django.db.models.fields.related.ForeignKey')(default='1', to=orm['certificates.CertificateTemplate']), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Certificate.template'
        db.delete_column('certificates_certificate', 'template_id')
    ...
    models = {
        ...
        'certificates.certificatetemplate': {
            ...
            'filename': ('django.db.models.fields.CharField', [], {'max_length': '20', 'unique': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
